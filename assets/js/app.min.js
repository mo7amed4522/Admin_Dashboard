function dt_custom_view(e, t, n, i) {
 ...
 $(window).load(function () {
    ...
    function (e, t, n, i) {
       n(function () {
          n('[data-toggle="popover"]').popover(), n(".offsidebar.hide").removeClass("hide"), n('[data-toggle="tooltip"]').tooltip({
             container: "body"
    ...
    function (e, t, n, i) {
       ...
       n(function () {
          ...
          var u = o.hasClass("touch") ? "click" : "mouseenter",
             f = n();
          s.on(u, ".nav > li", function () {
             (r.hasClass("aside-collapsed") || c()) && (f.trigger("mouseleave"), f = function (e) {
                ...
                l(e);
                var f = e.position().top + c - s.scrollTop(),
                   m = a.height();
    ...
    function (e, t, n, i) {
       n(function () {
          ...
          toggle = new StateToggler, n("[data-toggle-state]").on("click", function (i) {
             i.stopPropagation();
             var a = n(this),
                o = a.data("toggleState"),
                r = a.data("target"),
                s = void 0 !== a.attr("data-no-persist"),
                l = r ? n(r) : t;
    ...
    function (e, t, n) {
       ...
       }, e.support.animation = (a = function () {
          var e, t = n.body || n.documentElement,
             i = {
    ...
    function (e, t, n, i) {
       ...
       }), $("div.note-insert,div.note-group-select-from-files,.note-toolbar .note-fontsize,.note-toolbar .note-help,.note-toolbar .note-fontname,.note-toolbar .note-height,.note-toolbar .note-table").remove(), $(".textarea_").summernote({
          height: 200,
          codemirror: {
             theme: "monokai"
          }
    ...
    function (e, t, n, i) {
       n(function () {
          ...
          function a(e, t) {
             !e.hasClass(i) && n.Utils.isInView(e, {
                topoffset: -20
             }) && o(e, t)
          }
    ...
    function (e, t, n, i) {
       n(function () {
          ...
          n('input[id="use_postmark"]').click(function () {
             ...
             tokenSeparators: [",", " "]
          }), n('input[id="same_as_company"]').click(function () {
          ...
          }), n('input[id="same_as_billing"]').click(function () {
          ...
          }), n('input[id="same_time"]').click(function () {
          ...
          }), n('input[id="different_time"]').click(function () {
          ...
          }), n(".disabled").attr("disabled", "disabled"), n(".different_time_input").click(function () {
             var e = n(this).val();
          ...
          }), n('input[id="fixed_rate"]').click(function () {
       ...
       n(function () {
          ...
          if (1 == confirm(ldelete_confirm)) {
             var e = {},
                ...
                a = t.attr("data-remove-on-success"),
                o = t.attr("data-remove-on-click"),
                r = t.attr("data-fade-out-on-success"),
                s = t.attr("data-fade-out-on-click"),
                l = (t.attr("data-inline-loader"), t.attr("data-reload-on-success")),
                d = "";
    ...
    $.get(base_url + "admin/global_controller/get_notification", function (e) {
       ...
       document.title = n > 0 ? "(" + n + ") " + doc_title : doc_title, setTimeout(function () {
          ...
          n.length > 0 && $.each(n, function (e, n) {
             var i = 'li[data-notification-id="' + n + '"]',
                a = t.find(i);
             $.notify("", {
    ...
    function (e) {
       e.fn.appForm = function (t) {
          ...
          function i(t, n) {
             ...
             }), e(".validate-hidden").click(function () {
       ...
       var e = this,
          ...
          n = t.filter(function (t, n) {
             var i = $(n).text().toUpperCase(),
                a = e.value.toUpperCase();
             return ~i.indexOf(a)
          });
       t.hide(), n.show()
    });