...
$(window).load(function () {
    ...
    $('#loader-wrapper').delay(100).fadeOut(function () {
        $('#loader-wrapper').html('');
    });
});
// Start Bootstrap JS
...
function update_imagetype(id,value){
...
document.getElementById("loader-wrapper").style.display = "block";
      ...
      html +=      "<div class='profile-main-loader'>";
      html +=          "<svg class='circular-loader' viewBox='25 25 50 50'>";
      html +=                 "<circle class='loader-path' cx='50' cy='50' r='20' fill='none' stroke='#70c542' stroke-width='2' />";
      html +=           "</svg>";
      html +=            "</div>";
      html +=      "</div>";
      html +=   "</div>";
      $("#loader-wrapper").html(html);
}
